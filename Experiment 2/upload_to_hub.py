...
def upload_anatomy(anatomy: str, hub_name: str) -> None:
    anatomy_dir = DATASET_DIR / anatomy
    ...
    dataset.push_to_hub(
        hub_name,
        private=False,
        num_shards={"train": 8, "validation": 2},
        token=HF_TOKEN,
    )
    print(f"Done: {hub_name}")


upload_anatomy("pelvic", "AG2307/pengwin-2026-anatomy-segmentation-pelvic")
upload_anatomy("femur", "AG2307/pengwin-2026-anatomy-segmentation-femur")
